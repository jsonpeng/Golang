...
/** Flag bit-mask definition for Z/IP frame */
#define ZIP_FLAG_SECURE         0x01    ///< frame is secure
#define ZIP_FLAG_ACK_REQ        0x02    ///< set the Z/IP frame ACK request bit
#define ZIP_FLAG_ACK_RESP       0x04    ///< set the Z/IP frame ACK response bit
#define ZIP_FLAG_NACK_OPT_RESP  0x08    ///< set the Z/IP frame NACK response bit and "option error" bit
#define ZIP_FLAG_HDR_EXT        0x10    ///< set the Z/IP frame header extension included bit
#define ZIP_FLAG_ENCAP_INFO     0x20    ///< frame contains Z-wave encapsulation format info
#define ZIP_FLAG_MORE_INFO      0x40    ///< set the Z/IP frame "more information" bit

/** Z/IP frame option types */
#define ZIP_OPT_EXP_DELAY   0x01    ///< Expected delay
#define ZIP_OPT_MAINTN_GET  0x02    ///< Installation and maintenance get
#define ZIP_OPT_MAINTN_RPT  0x03    ///< Installation and maintenance report
