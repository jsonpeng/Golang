/**
@file   zip_wkup_poll.c - Z-wave High Level API wake-up notification poll header file.
...
#define WUPOLL_CHK_DOWN_INTV          (600 * WUPOLL_TICK_PER_SEC)  /**< Polling for down entries check interval
                                                                        in terms of timer tick */
//#define WUPOLL_CHK_ACTIVE_INTV        (30 * 60 * WUPOLL_TICK_PER_SEC)  /**< Testing ,Polling for active entries interval
//                                                                        in terms of timer tick */
#define WUPOLL_CHK_ACTIVE_INTV        (12 * 3600 * WUPOLL_TICK_PER_SEC)  /**< Polling for active entries interval
                                                                        in terms of timer tick */
