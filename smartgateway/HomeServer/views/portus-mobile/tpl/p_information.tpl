...
<input id="FromeDate" class="date-picker form-control" type="text" name="password" value="{{.password}}" placeholder="{{.password}}" ng-model="password" ng-minlength="6"
                    ng-maxlength="16" name="password" id="password"
