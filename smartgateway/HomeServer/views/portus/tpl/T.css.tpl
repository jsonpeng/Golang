...
<style type="text/css">
/*form{width:600px;height:200px;margin:50px auto 0 auto;}*/
...
.info,.safe{display:none;margin-left:5px;width:247px;height:30px;background:url(/static/img/info.gif) no-repeat;position:absolute;left:250px;top:0;color:#666;padding:10px 0 0 40px;}
.user_put{height:80px;line-height:26px;}
.pass_put{height:60px;line-height:26px;}
.info_error{display:none;width:247px;height:30px;margin-left:5px;background:url(/static/img/info.gif) no-repeat 0 -190px;position:absolute;left:250px;top:0; color:red;padding:10px 0 0 40px;}
...
.ok{display:none;width:20px;height:20px;background:url(/static/img/ok.gif) no-repeat;position:absolute;left:260px;top:8px;}
